summon minecraft:falling_block ~ ~ ~ {BlockState:{Name:"minecraft:snow"},Time:1}
summon minecraft:falling_block ~ ~ ~1 {BlockState:{Name:"minecraft:snow"},Time:1}
summon minecraft:falling_block ~ ~ ~-1 {BlockState:{Name:"minecraft:snow"},Time:1}
summon minecraft:falling_block ~1 ~ ~ {BlockState:{Name:"minecraft:snow"},Time:1}
summon minecraft:falling_block ~-1 ~ ~ {BlockState:{Name:"minecraft:snow"},Time:1}

summon minecraft:falling_block ~1 ~ ~1 {BlockState:{Name:"minecraft:snow"},Time:1}
summon minecraft:falling_block ~1 ~ ~-1 {BlockState:{Name:"minecraft:snow"},Time:1}
summon minecraft:falling_block ~-1 ~ ~1 {BlockState:{Name:"minecraft:snow"},Time:1}
summon minecraft:falling_block ~-1 ~ ~-1 {BlockState:{Name:"minecraft:snow"},Time:1}
