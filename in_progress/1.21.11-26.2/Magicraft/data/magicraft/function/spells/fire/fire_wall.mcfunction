...
summon minecraft:falling_block ^-3 ^ ^4 {BlockState:{Name:"minecraft:fire"},Time:1}
summon minecraft:falling_block ^-2 ^ ^4 {BlockState:{Name:"minecraft:fire"},Time:1}
summon minecraft:falling_block ^-1 ^ ^4 {BlockState:{Name:"minecraft:fire"},Time:1}

summon minecraft:falling_block ^ ^ ^4 {BlockState:{Name:"minecraft:fire"},Time:1}
