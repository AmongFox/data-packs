...
execute as @e[distance=0.1..16] at @s run summon minecraft:spectral_arrow ~ ~10 ~ {Tags:["magicraft.spell.arrow.spectral_arrow_rain"],Motion:[0.0,-0.1f,0.0],player:1b,pickup:0b}
