...
execute unless score @s utils.player.id matches 1.. run function graves:internal/playerload

execute unless score @s utils.player.id matches 1.. run return fail
execute unless function graves:internal/playercheck/grave run return fail
...
execute align xyz positioned ~0.5 ~ ~0.5 run function graves:internal/entity/grave/spawn with storage graves:death data

data remove storage graves:death data

function graves:internal/playerclear

execute if score death_message graves.config matches 1 run function graves:internal/playertrigger/use/last_grave